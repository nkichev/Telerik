//Not my code, because I couldn't solve it, but in the end understood how it works...
...
var familyMembers = [
    ...
    },
    {
        ...
        children: ['Martin Stamatov', 'Maria Stamatova']
    },
    {
...
function makeTree(familyTree) {
    ...
    for (i = 0; i < familyMembers.length; i++) {
        ...
        for (k = 0; k < 2; k++) {
            ...
            parentsAndDescendants.push(text);
    ...
    parentsAndDescendants.sort();
    for (i = 0; i < familyMembers.length; i++) {
        for (var j = 0; j < familyMembers[i].children.length; j++) {
            if (parentsAndDescendants.indexOf(familyMembers[i].children[j]) == -1) {
