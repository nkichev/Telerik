...
- (void)viewDidLoad {
    ...
    Password *firstPass = [[Password alloc] initWithName:@"First pass" andCode:@"111"];
    Password *secondPass = [[Password alloc] initWithName:@"Second pass" andCode:@"333"];
    [self.passwords addObject:firstPass];
    [self.passwords addObject:secondPass];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    vc.password = self.passwords[path.row];
